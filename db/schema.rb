...
ActiveRecord::Schema[8.0].define(version: 2025_03_09_023311) do
  ...
  create_table "option_profiles", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "place_of_birth", default: ""
    t.string "bio", default: ""
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_option_profiles_on_user_id"
  end
  ...
  add_foreign_key "option_profiles", "users"
end
